...
## HL subjects
Computer Science HL, Mathematics AA HL, and Physics HL.

## Previous curriculum
Completed the IGCSE curriculum prior to IBDP.
...
## Boarding student
Lives in dorms at school. Had difficult dorm experiences initially.

## Self-taught programming
Self-learned Python during middle school.
...
## Physics teacher
His physics teacher organizes fun, hands-on activities covering light waves, forces, and other topics. This is part of why physics is his favorite subject.

## Favorite engineering topics
Computer hardware, chip design, and the underlying principles of algorithms. Enjoys understanding how computers work at the hardware level.

## Interest in astrophysics
Interested in astrophysics topics: rockets, planets, and space exploration.

## Math: probability in lottery systems
Applied probability concepts to understand how math is used in lottery systems. (Part of his broader interest in applying math to real-world systems.)

## National History Day
Participated in National History Day, researching American history topics.
